...
function AdminDashboard() {
    ...
    useEffect(() => {
        if (authToken) {
            ...
            fetchTeachersForCourseDropdown(authToken);
            fetchStudentList(authToken);
        }
    }, [authToken]);
    ...
    const fetchTeachersForCourseDropdown = async (token) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                console.error('Failed to fetch teachers for dropdown/list:', response.status);
                setTeacherListError('Failed to fetch teachers.');
                toast.error('Failed to fetch teachers.');
            }
        } catch (error) {
            console.error('Error fetching teachers for dropdown/list:', error);
            setTeacherListError('Network error fetching teachers.');
    ...
    const fetchStudentList = async (token) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                setStudentListError('Failed to fetch students.');
                toast.error('Failed to fetch students.');
            }
        } catch (error) {
            console.error('Error fetching students:', error);
            setStudentListError('Network error fetching students.');
    ...
    const renderDashboardContent = () => (
        <>
            {/* ... (rest of the renderDashboardContent as provided before) */}
